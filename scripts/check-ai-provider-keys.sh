...
const probes = [
  ...
  ["huggingface", ["HF_TOKEN", "HF_TOKEN_API_KEY"], "https://router.huggingface.co/v1/models", (key) => ({authorization: `Bearer ${key}`})],
  ["github", "GITHUB_MODELS_TOKEN", "https://models.github.ai/catalog/models", (key) => ({authorization: `Bearer ${key}`, "x-github-api-version": "2022-11-28"})],
