...
export interface DeliveryQuote { distance_km: number; delivery_fee: number; total: number; }
export interface TrackingSnapshot { tracking: { tracking_code: string; status: string; updated_at: string; zone_name: string; rider_name: string | null } }
