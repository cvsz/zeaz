# Services and Documentation Authority
...
Root summary files link to these authorities. Dated `*_REPORT.md` documents are
historical evidence and must not override executable configuration or current
contracts.
